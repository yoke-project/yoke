...
| **Planning item** | yoke-project/yoke#71 |

## yoke:the-check-runner.01 — a check whose name holds a digit is run
...
## yoke:the-check-runner.02 — a marker whose check cannot be found is reported as failing
