...
func Run(args []string, out, errOut io.Writer) int {
	if len(args) == 0 {
		fmt.Fprintln(errOut, "yoke-verify: no subcommand; expected descriptions or markers")
		return 2
	}
	...
	default:
		fmt.Fprintf(errOut, "yoke-verify: no subcommand %q; expected descriptions or markers\n", subcommand)
		return 2
	}
}
